...
export const reminderTemplate =(Name ,session,content)=>{
    // export const reminderTemplate =(Name,sessionLink ,session)=>{
    return `
        <head>
            <title></title>
            ...
            <div style="background-color:#F9F9F9;"><!--[if mso | IE]>
                ...
                <div style="margin:0px auto;max-width:640px;background:transparent;"><table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;background:transparent;" align="center" border="0"><tbody><tr><td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:40px 0px;"><!--[if mso | IE]>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:undefined;width:640px;">
                        <![endif]--><div style="cursor:auto;color:white;font-family:Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-size:30px;font-weight:600;line-height:36px;text-align:center;">
                        

                        <!-- aaaaaaaaaaaaaaaaaaaaaaaaaaaaa -->
                        Reminder from Bashmohands👻</div><!--[if mso | IE]>
                        <!-- aaaaaaaaaaaaaaaaaaaaaaaaaaaaa -->
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;width:640px;">
                        ...
                        <!-- aaaaaaaaaaaaaaaaaaaaaaaaaaaaa -->
                        Hello ${Name} !</h2>
                        <p>Remember the upcoming session well of course take place ${content}, <br>
                        the Link of the meeting is below.
                        https://www.bashmohands.com/en/blog/reminder-email
                        Meeting Details:
                        Date: [${session.date}]
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;width:640px;">
                        ...
                        Sent by Bashmohands • <a href="https://bashmohands.onrender.com/" style="color:#1EB0F4;text-decoration:none;" target="_blank">check our blog</a> • <a href="https://twitter.com/discordapp" style="color:#1EB0F4;text-decoration:none;" target="_blank">@discordapp</a>
