...
export const welcomeTemplate =(Name,token)=>{
    return `
        <head>
            <title></title>
            ...
            <div style="background-color:#F9F9F9;"><!--[if mso | IE]>
                ...
                <div style="margin:0px auto;max-width:640px;background:transparent;"><table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0px;width:100%;background:transparent;" align="center" border="0"><tbody><tr><td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:40px 0px;"><!--[if mso | IE]>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:undefined;width:640px;">
                        ...
                        Welcome to Bashmohands👻</div><!--[if mso | IE]>
                        <!-- aaaaaaaaaaaaaaaaaaaaaaaaaaaaa -->
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td style="vertical-align:top;width:640px;">
                        ...
                        <!-- aaaaaaaaaaaaaaaaaaaaaaaaaaaaa -->
                        Hello ${Name} !</h2>
                        <p>Thanks for signing up for our newsletter! You’re joining an amazing community of Teaching and Education. <br>
                        Want more? Follow us on social media and get your daily dose of advice and inspiration:
                        ...
                        <a href="http://localhost:3000/api/v1/user/Verify?token=${token}" style="text-decoration:none;line-height:100%;background:#7289DA;color:white;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:15px;font-weight:normal;text-transform:none;margin:0px;" target="_blank">
                                Verify Email
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="640" align="center" style="width:640px;">
                        ...
                        <![endif]-->
                        <!--[if mso | IE]>
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="640" align="center" style="width:640px;"><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
